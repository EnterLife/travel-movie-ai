...
| 3. Frame Sampling | Start/middle/end contact sheet реализован |
| 4. Vision Analysis | LM Studio/Qwen flow реализован |
| 5. Quality Analysis | Базовые OpenCV/Pillow metrics реализованы |
...
Scene Detection (semantic mode)
    ...
    +--> importance, quality and diversity ranking
    |
    v
quick_timeline.json
    |
