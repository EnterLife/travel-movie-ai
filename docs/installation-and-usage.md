...
Текущая версия включает Media Scan и Quick Montage. Media Scan:
...
После анализа кнопка `Собрать фильм`:
...
6. Настройте длительность фильма, видеофрагмента и показа фотографии.
7. Нажмите `Собрать фильм`.
8. Просмотрите или скачайте MP4.
...
План текущего быстрого монтажа:
...
Quick Montage пока не выполняет AI-анализ смысла, не добавляет музыку и
переходы, не удаляет дубли и не оценивает качество сцен.
