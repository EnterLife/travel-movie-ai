...
| 3. Frame Sampling | Реализована, start/middle/end RGB PNG contact sheet |
...
| 6. Speech Analysis | Опциональный Faster Whisper реализован |
| 7. Audio Analysis | Заглушка |
| 8. Embeddings | Заглушка |
| 8.2. Duplicate Detection | Perceptual hash grouping реализован |
...
| 10. Story Builder | Детерминированный event-based storyboard реализован |
...
- нет embedding-based duplicate detection;
- нет ручного event editor, generated titles и subtitles;
